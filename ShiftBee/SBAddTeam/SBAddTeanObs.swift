...
class SBAddTeanObs {
    ...
    var cellObs: [SBSelectionNameCell.Obs]
    var nameError: SBNameError = .idle
    var popupState: SBPopupState<SBHourShiftInfo, SBNameError>
    ...
    func toggleError(error: SBNameError) {
        withAnimation {
