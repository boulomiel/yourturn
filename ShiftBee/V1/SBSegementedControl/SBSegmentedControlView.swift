...
struct SBSegmentedControlView<Case: SBSegmentValueCase>: View {
...
#Preview {
    @Previewable @State var selectedCase: SBShiftCase = .persons
    SBSegmentedControlView(cases: SBShiftCase.allCases, selectedCase: $selectedCase)
}
