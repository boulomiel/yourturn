...
struct SBDisclosureSelect {
    let cellTitle: String
    let cellList: [String]
}

struct SBDisclosureGroup: View {
    typealias Cell = String
    let cellTitle: String
    let cellList: [Cell]
    let onListSelected: (SBDisclosureSelect) -> Void
...
#Preview {
    SBDisclosureGroup(cellTitle: "Hello", cellList: ["Jhon", "Phil", "Plo", "Mary"]) { _  in }
