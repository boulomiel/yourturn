...
public class SBStorage: NSObject {
    
    nonisolated public static func archiveStringArray(object : [String]) -> Data {
        do {
    ...
    nonisolated public static func loadStringArray(data: Data) -> [String] {
        do {
